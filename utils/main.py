...
#
#         # 步骤2: 构建动态SQL语句
#         sql, params = query_builder.build_query('findOperator', name="张三", id=1)
#         print(f"步骤2: SQL构建完成")
#         print(f"生成的SQL: {sql}")
#         print(f"参数: {params}")
#
...
#     main()
    ...
    # current_dir = os.path.dirname(os.path.abspath(__file__))
    # xml_file_path = os.path.join(current_dir, 'dbscript', 'operatorQuery.xml')
    ...
    try:
        ...
        # 测试2: 只有name
        print("\n=== 测试2: 只有name ===")
        sql, params = query_builder.build_query('findOperator', name="Admin")
        print(f"生成的SQL: {sql}")
        print(f"参数: {params}")
        ...
        # 测试3: 只有id
        print("\n=== 测试3: 只有id ===")
        sql, params = query_builder.build_query('findOperator', id="GMgR2KCLiFCr3wRPEP20GMygzEoWJKHz")
        print(f"生成的SQL: {sql}")
        print(f"参数: {params}")
